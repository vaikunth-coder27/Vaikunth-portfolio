...
type LimelightNavProps = {
  ...
  /** Controlled active index — syncs limelight to external state (e.g. IntersectionObserver) */
  activeIndex?: number;
 ...
 * Supports both uncontrolled (defaultActiveIndex) and controlled (activeIndex) modes.
 */
